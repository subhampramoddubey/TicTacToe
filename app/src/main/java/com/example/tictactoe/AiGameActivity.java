...
import static com.example.tictactoe.Minmax.findBestMove;
...
public class AiGameActivity extends AppCompatActivity implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn= (ImageView) findViewById(R.id.Ai_game_back_btn);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(AiGameActivity.this,MainActivity.class);
                startActivity(i);
            }
        });
